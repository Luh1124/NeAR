...
def check_single_sha256(sha256, slat_dir, shade_dir, relight_dir, n_shade=12):
    ...
    shade_slat_path = os.path.join(slat_dir, f"{sha256}.npz")
    ...
    pairs.append((slat_path, shade_slat_path, relight_image_dir, num_voxel))
...
if __name__ == "__main__":
    main(
        ...
        shade_dir="/root/data/shadedgt_20260127/3diclight_rendering_0126/3diclight_shaded_gt_8w9_0126/pbr2dinov2_voxel_64_shaded_slat",
        # relight_dir="/root/data/3diclight/8w9_neural_light_v6",
        relight_dir="/root/data/shadedgt_20260127/3diclight_rendering_0126/3diclight_shaded_gt_8w9_0126_random/8w9_shaded_gt",
        
        # 参数
        n_shade=40,           # 每个样本的 shade 数量
        max_workers=32,       # 并行线程数（可根据机器调整 8-32）
        
        # 输出文件
        out_train="data_csvs/train_shade_slat_to_even_slat_gt.csv",
        out_val="data_csvs/val_shade_slat_to_even_slat_gt.csv",
