...
class LinearWarmupStepLRScheduler(LambdaLR):
    def __init__(self, optimizer, warmup_steps, milestone_steps, decay_rate=0.9, last_epoch=-1):
        self.milestone_steps = milestone_steps
        self.warmup_steps = warmup_steps
        self.decay_rate = decay_rate
        super(LinearWarmupStepLRScheduler, self).__init__(optimizer, self.lr_lambda, last_epoch=last_epoch)
